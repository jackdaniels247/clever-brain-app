...
onSubmitChange=()=>{
  fetch('https://whispering-savannah-29487.herokuapp.com/signin',{
    method:'post',
...
<div className="lh-copy mt3">
  <p onClick={()=>this.props.onClickChange('register')} className="f6 link dim black db pointer">Register</p>
